...
QT_MOC_LITERAL(1, 13, 11), // "OPenGL_Init"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11) // "OPenGL_Draw"

    },
    "OpenGLWidget\0OPenGL_Init\0\0OPenGL_Draw"
};
...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OPenGL_Init(); break;
        case 1: _t->OPenGL_Draw(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWidget::OPenGL_Init)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OpenGLWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWidget::OPenGL_Draw)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void OpenGLWidget::OPenGL_Init()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void OpenGLWidget::OPenGL_Draw()
{
